    ...
    <div id="about" className="base-section">
      <div className="about">
        <div className="about__heading">
          <p className="about__title">{"I'm Buddy Lim,\na web developer based in Singapore"}</p>
          <div className="about__description">
            <p>My main expertise lies in web development where I primarily use React for front-end and NodeJS for back-end.</p>
            <p>I am also familiar with Unity and Unreal game engines as I have used these engines to develop games during my degree</p>
            <p>Got anything interesting or something you'd like to share? Feel free to reach out to me!</p>
          </div>
        </div>
